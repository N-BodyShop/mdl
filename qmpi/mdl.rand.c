 ...
 **
 ** This version uses the random cache line replacement scheme like
 ** t3empi.  In general, I found that the LRU (the default mdl.c) to be
 ** better on LeMieux.psc.edu.
 */
#include <stdio.h>
#include <stdlib.h>
#include <stddef.h>
